...
args.det_config = r'D:\openmmlab\mmaction2\demo\demo_configs\faster-rcnn_r50-caffe_fpn_ms-1x_coco-person.py'  # noqa: E501
...
args.pose_config = r'D:\openmmlab\mmaction2\demo\demo_configs\td-hm_hrnet-w32_8xb64-210e_coco-256x192_infer.py'  # noqa: E501
...
def file_process(video, output, device='cuda:0', skip_postproc='store_true'):
    args.device = device
    args.video = video
    args.output = output
    args.skip_postproc = skip_postproc
